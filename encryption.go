// https://shineyangpro.com/golang-de-aes-jia-mi-he-jie-mi-de-san-chong-mo-shi-cbc-ecb-cfb/
package main
...
func main() {
	origData := []byte("right there") // data to be encrypted
	key := []byte("BPRKScredit236!#") // encrypted key
